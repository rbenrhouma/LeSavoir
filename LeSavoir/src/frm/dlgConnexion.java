...
public class dlgConnexion extends JFrame {
	...
	public static ApplicationConnexion ApplicationSession; // Connexion à la
															// base de travail
	...
	public dlgConnexion() {
		...
		lblNewLabel_1.setIcon(
				new ImageIcon(dlgConnexion.class.getResource("/Images/photodune-6908996-databasejpg-xs2.jpg")));
		...
		panel_1.setBorder(
				new TitledBorder(UIManager.getBorder("TitledBorder.border"), "  SQL Serveur   [ Base Syst\u00E8me ]  ",
		...
		cbDataBaseName.setModel(new DefaultComboBoxModel(new String[] {"Philippe GRENIER", "LE_SAVOIR", "M.A.V.I.E"}));
		...
		eDataBaseName.setVisible(false);
		...
		panel_3.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "  SQL Serveur   ",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		...
		lblNewLabel_3.setIcon(new ImageIcon(
				dlgConnexion.class.getResource("/Images/syst\u00E8me-de-gestion-de-base-de-donn\u00E9es-2.jpg")));
